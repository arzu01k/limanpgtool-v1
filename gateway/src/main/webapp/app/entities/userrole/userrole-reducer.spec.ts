...
import { IUserrole, defaultValue } from 'app/shared/model/userrole.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './userrole.reducer';
