...
import tr.com.havelsan.limanpgtool.gateway.repository.rowmapper.UserRowMapper;
import tr.com.havelsan.limanpgtool.gateway.repository.rowmapper.UserroleRowMapper;
...
class UserroleRepositoryInternalImpl extends SimpleR2dbcRepository<Userrole, Long> implements UserroleRepositoryInternal {
    ...
    private static final Table entityTable = Table.aliased("userrole", EntityManager.ENTITY_ALIAS);
    ...
    @Override
    public Mono<Userrole> findOneWithEagerRelationships(Long id) {
        return findById(id);
    }

    @Override
    public Flux<Userrole> findAllWithEagerRelationships() {
        return findAll();
    }

    @Override
    public Flux<Userrole> findAllWithEagerRelationships(Pageable page) {
