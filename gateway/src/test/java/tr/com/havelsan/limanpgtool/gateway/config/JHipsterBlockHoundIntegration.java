...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tr.com.havelsan.limanpgtool.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "tr.com.havelsan.limanpgtool.gateway.security.DomainUserDetailsService",
